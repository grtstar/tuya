...
TARGET_PLATFORM=aarch64-linux-gnu-gcc-6.3.1
TARGET_PLATFORM_REPO=https://airtake-public-data-1254153901.cos.ap-shanghai.myqcloud.com/smart/embed/pruduct/aarch64-linux-gnu-gcc-6.3.1_1.0.1-beta.3.zip
TARGET_PLATFORM_VERSION=1.0.1-beta.3
ROOT_DIR=$(pwd)
