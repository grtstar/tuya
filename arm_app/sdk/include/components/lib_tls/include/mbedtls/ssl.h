...
struct mbedtls_ssl_context
{
    ...
    unsigned char fargment_send_en;
    unsigned char fragment_rev_en;
    unsigned char *fragment_buf;
    unsigned char *fargment_in_msg;
    size_t fragment_buf_len;
    size_t fragment_out_msglen;
    size_t fragment_offset;
#endif
#if defined(MBEDTLS_SUPPORT_DYNAMIC_MEMORY)
