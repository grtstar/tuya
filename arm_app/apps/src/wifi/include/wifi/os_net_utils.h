...
#define LOGI OS_NET_INFO
#define LOGD OS_NET_DEBUG
#define LOGE OS_NET_ERROR
#define LOGW OS_NET_WARN
#define LOGDEBUG OS_NET_DEBUG

// #define OS_NET_INFO(fmt, arg...) PrintLogEx(INFO,  __FUNCTION__, __LINE__, fmt, ##arg)
// #define OS_NET_DEBUG(fmt, arg...) PrintLogEx(DEBUG,  __FUNCTION__, __LINE__, fmt, ##arg)
// #define OS_NET_ERROR(fmt, arg...)  PrintLogEx(ERROR,  __FUNCTION__, __LINE__, fmt, ##arg) 
// #define OS_NET_WARN(fmt, arg...)    PrintLogEx(WARNING,  __FUNCTION__, __LINE__, fmt, ##arg)
